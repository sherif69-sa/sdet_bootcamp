...
| How do we prove readiness? | Emit Name 23 FAQ pack and attach evidence summary in release review. | `python -m sdetkit faq-objections --emit-pack-dir docs/artifacts/name23-faq-pack --format json --strict` |
