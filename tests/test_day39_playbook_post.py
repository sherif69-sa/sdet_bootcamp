...
def _seed_repo(root: Path) -> None:
    ...
    (root / "docs/integrations-day39-playbook-post.md").write_text(d39._DAY39_DEFAULT_PAGE, encoding="utf-8")
    (root / "docs/day-39-big-upgrade-report.md").write_text("# Day 39 report\n", encoding="utf-8")

    summary = root / "docs/artifacts/day38-distribution-batch-pack/day38-distribution-batch-summary.json"
...
def test_day39_strict_fails_when_day38_inputs_missing(tmp_path: Path) -> None:
    _seed_repo(tmp_path)
    (tmp_path / "docs/artifacts/day38-distribution-batch-pack/day38-distribution-batch-summary.json").unlink()
