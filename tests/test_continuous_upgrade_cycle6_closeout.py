...
def _seed_repo(root: Path) -> None:
    ...
    plan = root / "docs/roadmap/plans/continuous-upgrade-cycle6-plan.json"
    plan.write_text(
        json.dumps(
            {
