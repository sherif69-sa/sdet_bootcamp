...
def _seed_repo(root: Path) -> None:
    ...
    (root / "docs/integrations-day42-optimization-closeout.md").write_text(d42._DAY42_DEFAULT_PAGE, encoding="utf-8")
    (root / "docs/day-42-big-upgrade-report.md").write_text("# Day 42 report\n", encoding="utf-8")

    summary = root / "docs/artifacts/day41-expansion-automation-pack/day41-expansion-automation-summary.json"
...
def test_day42_strict_fails_when_day41_inputs_missing(tmp_path: Path) -> None:
    _seed_repo(tmp_path)
    (tmp_path / "docs/artifacts/day41-expansion-automation-pack/day41-expansion-automation-summary.json").unlink()
