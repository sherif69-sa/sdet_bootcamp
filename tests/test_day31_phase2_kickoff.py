...
def _seed_repo(root: Path) -> None:
    ...
    summary.write_text(json.dumps({"summary": {"activation_score": 97, "strict_pass": True}}, indent=2), encoding="utf-8")
    backlog = root / "docs/artifacts/day30-wrap-pack/day30-phase2-backlog.md"
    backlog.write_text("# Locked Phase-2 backlog\n- [ ] Day 31 baseline\n", encoding="utf-8")
...
def test_day31_emit_pack_and_execute(tmp_path: Path) -> None:
    ...
    assert (tmp_path / "artifacts/day31-pack/day31-weekly-targets-checklist.md").exists()
