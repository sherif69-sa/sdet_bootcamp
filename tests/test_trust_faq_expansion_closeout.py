...
def _seed_repo(root: Path) -> None:
    ...
    (root / "docs/index.md").write_text(
        "impact-83-big-upgrade-report.md\nintegrations-trust-faq-expansion-closeout.md\n",
        encoding="utf-8",
    )
    ...
    (root / "docs/impact-83-big-upgrade-report.md").write_text("# Day 83 report\n", encoding="utf-8")
    ...
    plan = root / "docs/roadmap/plans/trust-faq-expansion-plan.json"
    plan.write_text(
        json.dumps(
            {
