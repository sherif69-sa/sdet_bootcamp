...
subprocess.call('echo z', shell=False)
subprocess.check_call('echo zz', shell=False)
subprocess.check_output('echo zzz', shell=False)
sp.run('echo alias', shell=False)
cc('echo alias-cc', shell=False)
co('echo alias-co', shell=False)
run('echo direct-import-run', shell=False)
""".strip()
