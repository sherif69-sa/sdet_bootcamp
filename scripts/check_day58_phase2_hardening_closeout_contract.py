...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Day 58 Phase-2 hardening closeout contract")
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day58-phase2-hardening-closeout-pack/evidence/day58-execution-summary.json"
    ...
    if errors:
        print("day58-phase2-hardening-closeout contract check failed:", file=sys.stderr)
        for err in errors:
            print(f"- {err}", file=sys.stderr)
        return 1

    print("day58-phase2-hardening-closeout contract check passed")
    return 0
