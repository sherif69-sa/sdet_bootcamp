...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Day 74 distribution scaling closeout contract")
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day74-distribution-scaling-closeout-pack/evidence/day74-execution-summary.json"
