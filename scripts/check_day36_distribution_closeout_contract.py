...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day36-distribution-closeout-pack/evidence/day36-execution-summary.json"
