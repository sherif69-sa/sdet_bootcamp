...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate Day 85 release prioritization closeout contract"
    )
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/day85-release-prioritization-closeout-pack/evidence/day85-execution-summary.json"
        )
