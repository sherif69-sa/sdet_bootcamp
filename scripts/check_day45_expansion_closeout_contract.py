...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/day45-expansion-closeout-pack/evidence/day45-execution-summary.json"
        )
