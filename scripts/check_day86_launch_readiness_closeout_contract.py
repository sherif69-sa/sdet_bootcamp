...
from sdetkit import day86_launch_readiness_closeout as d85
...
def main() -> int:
    ...
    payload = d85.build_day86_launch_readiness_closeout_summary(root)
    errors: list[str] = []
    ...
    if errors:
        print("day86-launch-readiness-closeout contract check failed:", file=sys.stderr)
        for error in errors:
            print(f"- {error}", file=sys.stderr)
        return 1

    print("day86-launch-readiness-closeout contract check passed")
    return 0
