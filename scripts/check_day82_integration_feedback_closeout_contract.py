...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate Day 82 integration feedback closeout contract"
    )
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/day82-integration-feedback-closeout-pack/evidence/day82-execution-summary.json"
        )
