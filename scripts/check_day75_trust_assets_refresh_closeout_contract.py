...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Day 75 trust assets refresh closeout contract")
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day75-trust-assets-refresh-closeout-pack/evidence/day75-execution-summary.json"
    ...
    if errors:
        print("day75-trust-assets-refresh-closeout contract check failed:", file=sys.stderr)
        for err in errors:
            print(f"- {err}", file=sys.stderr)
        return 1

    print("day75-trust-assets-refresh-closeout contract check passed")
    return 0
