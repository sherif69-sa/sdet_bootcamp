...
def main() -> int:
    ...
    payload = d81.build_day81_growth_campaign_closeout_summary(root)
    errors: list[str] = []
    ...
    if errors:
        print("day81-growth-campaign-closeout contract check failed:", file=sys.stderr)
        for err in errors:
            print(f"- {err}", file=sys.stderr)
        return 1

    print("day81-growth-campaign-closeout contract check passed")
    return 0
