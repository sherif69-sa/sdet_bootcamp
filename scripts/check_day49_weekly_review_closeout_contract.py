...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day49-weekly-review-closeout-pack/evidence/day49-execution-summary.json"
