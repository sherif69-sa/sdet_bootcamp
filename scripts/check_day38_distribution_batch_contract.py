...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day38-distribution-batch-pack/evidence/day38-execution-summary.json"
