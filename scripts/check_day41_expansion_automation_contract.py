...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day41-expansion-automation-pack/evidence/day41-execution-summary.json"
