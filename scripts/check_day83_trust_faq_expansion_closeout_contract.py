...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate Day 83 trust FAQ expansion closeout contract"
    )
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/day83-trust-faq-expansion-closeout-pack/evidence/day83-execution-summary.json"
        )
