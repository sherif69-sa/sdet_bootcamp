...
from sdetkit import day44_scale_closeout as d43


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Day 44 scale closeout contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root / "docs/artifacts/day44-scale-closeout-pack/evidence/day44-execution-summary.json"
        )
