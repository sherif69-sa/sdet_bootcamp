...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate Day 80 partner outreach closeout contract"
    )
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/day80-partner-outreach-closeout-pack/evidence/day80-execution-summary.json"
        )
